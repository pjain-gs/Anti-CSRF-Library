...
/**
 * Exception thrown whenever a failure occurs during creation of the CSRF protection service.
...
public class CSRFProtectionException extends RuntimeException {
     ...
     */
    public CSRFProtectionException(String msg) {
        this(msg, null);
    }
     ...
     */
    public CSRFProtectionException(String msg, Throwable t) {
        super(msg, t);
    }
