...
/**
 * This class contains fields to check for in the configuration file in order to read in properties from the DOM.
 * Default values for mandatory settings are also stored here.
 */
public class Constants {
    ...
    public static final String CONF_RULES_MANAGER_FACTORY_CLASS = "rules_manager_factory_class";
    public static final String CONF_PROTECTION_SERVICE_FACTORY_CLASS = "protection_service_factory_class";
    ...
    public static final String CONF_SESSION_CSRF_HEADER = "csrf_header";
    ...
    public static final String CONF_DEFAULT_CSRF_HEADER = "X-CSRF-TOKEN";
    ...
    static {
        ...
        defaultConfigs.put("csrf_header", "XCSRF");
