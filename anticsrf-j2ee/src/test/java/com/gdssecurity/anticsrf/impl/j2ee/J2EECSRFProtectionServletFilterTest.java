...
public class J2EECSRFProtectionServletFilterTest {
    ...
    public void setupServer() throws Exception {
        ...
        servletContextHandler.addFilter(J2EECSRFProtectionServletFilter.class, "/*",  EnumSet.of(DispatcherType.REQUEST))
                .setInitParameter("antiCSRFConfigFile", "./src/test/resources/sessionBasedConfig.xml");
    ...
    public void test_match() {
        try {
            ...
            String tok = Encode.forHtmlAttribute(response.getContentAsString());
    ...
    public void test_mismatch() {
        try {
            ...
            String tok = Encode.forHtmlAttribute(badToken);
    ...
    @Test
    public void test_mismatch_header() {
        try {
            hc.GET("http://localhost:8080/");
