...
public class CSRFTokenUrlSpecificUrlTag extends BodyTagSupport {
    ...
    private static final long serialVersionUID = 5386523516502060196L;
    ...
    /**
     * Adds URL specific CSRF Token variable for appending to a Query String
     *
     * @return
     */
    @Override
    public int doStartTag() {
        try {
            ...
            pageContext.getOut().print(
                    Encode.forUriComponent(tokenParamName) + "=" + Encode.forUriComponent(csrfToken));
